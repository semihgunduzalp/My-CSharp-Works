...
namespace Collections
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine(dictionary["table"]);  //sonucu tablo olarak verdi
            //Console.WriteLine(dictionary["glass"]); //olmadığı için hata verdi.
            ...
            Console.WriteLine(dictionary.ContainsKey("glass")); //false verdi
            Console.WriteLine(dictionary.ContainsKey("table")); //true verdi
        ...
        private static void List()
        {
            ...
            //customers.Remove(customer2);
            //customers.Remove(customer2);
            customers.RemoveAll(c => c.FirstName == "Salih"); //"Salih olanların hepsini siler.
